...
export default function About() {
    return (<>
    <h1 className='text text-primary' style={{marginLeft:'600px'}}>About Us</h1>
        <div className="container border border-3 border-primary " style={{overflow:'scroll',height:'600px',width:'800px'}}>
